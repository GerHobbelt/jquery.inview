...
The fifth variable visiblePercentWidth indicates the percentage visible width of the item 
The sixth variable visiblePercentHeight indicates the percentage visible height of the item 

bc.. $('div').bind('inview', function(event, isInView, visiblePartX, visiblePartY, visiblePercentWidth, visiblePercentHeight) {
  if (isInView) {
